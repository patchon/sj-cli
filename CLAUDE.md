...
# List back to a date instead of from today, cancelled bookings included (marked): a date, an
# ISO week, or an offset back from today
...
```bash
./venv/bin/pytest               # ~649 tests, <1s, no network
